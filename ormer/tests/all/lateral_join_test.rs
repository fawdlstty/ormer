...
async fn test_plain_left_join_impl(config: &crate::_test_common::DbConfig) {
...
async fn test_lateral_join_with_order_and_range_impl(config: &crate::_test_common::DbConfig) {
...
async fn test_lateral_join_order_only_impl(config: &crate::_test_common::DbConfig) {
    let select = Select::<TestUser>::new()
...
async fn test_lateral_join_range_only_impl(config: &crate::_test_common::DbConfig) {
...
async fn test_lateral_join_with_outer_filter_impl(config: &crate::_test_common::DbConfig) {
    let select = Select::<TestUser>::new()
        .left_join::<TestRole>(|p, q| p.id.eq(q.uid).order_by_desc(q.role_name).range(..1))
...
async fn test_plain_inner_join_impl(config: &crate::_test_common::DbConfig) {
...
async fn test_lateral_inner_join_with_order_and_range_impl(config: &crate::_test_common::DbConfig) {
    let select = Select::<TestUser>::new()
...
async fn test_plain_right_join_impl(config: &crate::_test_common::DbConfig) {
...
async fn test_lateral_right_join_with_order_and_range_impl(config: &crate::_test_common::DbConfig) {
    let select = Select::<TestUser>::new()
