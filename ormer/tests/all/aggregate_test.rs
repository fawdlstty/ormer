...
async fn test_count_aggregate_impl(
    ...
    crate::_test_common::prepare_table::<TestAggCountUser>(&db).await?;
    crate::_test_common::seed_score_users(&db, |id, name, age, score| TestAggCountUser {
        id,
        name: name.to_string(),
        age,
        score,
    ...
    crate::_test_common::clean_table::<TestAggCountUser>(&db).await?;
...
async fn test_sum_aggregate_impl(
    ...
    crate::_test_common::prepare_table::<TestAggSumUser>(&db).await?;
    crate::_test_common::seed_score_users(&db, |id, name, age, score| TestAggSumUser {
        id,
        name: name.to_string(),
        age,
        score,
    ...
    crate::_test_common::clean_table::<TestAggSumUser>(&db).await?;
...
async fn test_avg_aggregate_impl(
    ...
    crate::_test_common::prepare_table::<TestAggAvgUser>(&db).await?;
    crate::_test_common::seed_score_users(&db, |id, name, age, score| TestAggAvgUser {
        id,
        name: name.to_string(),
        age,
        score,
    ...
    crate::_test_common::clean_table::<TestAggAvgUser>(&db).await?;
...
async fn test_max_aggregate_impl(
    ...
    crate::_test_common::prepare_table::<TestAggMaxUser>(&db).await?;
    crate::_test_common::seed_score_users(&db, |id, name, age, score| TestAggMaxUser {
        id,
        name: name.to_string(),
        age,
        score,
    ...
    crate::_test_common::clean_table::<TestAggMaxUser>(&db).await?;
...
async fn test_min_aggregate_impl(
    ...
    crate::_test_common::prepare_table::<TestAggMinUser>(&db).await?;
    crate::_test_common::seed_score_users(&db, |id, name, age, score| TestAggMinUser {
        id,
        name: name.to_string(),
        age,
        score,
    ...
    crate::_test_common::clean_table::<TestAggMinUser>(&db).await?;
...
async fn test_aggregate_with_filter_impl(
    ...
    crate::_test_common::prepare_table::<TestAggFilterUser>(&db).await?;
    crate::_test_common::seed_score_users(&db, |id, name, age, score| TestAggFilterUser {
        id,
        name: name.to_string(),
        age,
        score,
    ...
    crate::_test_common::clean_table::<TestAggFilterUser>(&db).await?;
