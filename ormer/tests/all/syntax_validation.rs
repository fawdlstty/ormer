...
mod syntax_validation_tests {
    ...
    async fn test_model_constants_impl(config: &crate::_test_common::DbConfig) {
    ...
    async fn test_query_builder_creation_impl(config: &crate::_test_common::DbConfig) {
    ...
    async fn test_query_with_filter_impl(config: &crate::_test_common::DbConfig) {
    ...
    async fn test_complex_query_impl(config: &crate::_test_common::DbConfig) {
    ...
    async fn test_sql_generation_placeholders_impl(config: &crate::_test_common::DbConfig) {
