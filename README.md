...
It also includes raw SQL parameter binding, relation loading, typed derived tables, model filters, dynamic table routing, hooks, and versioned migration support.
